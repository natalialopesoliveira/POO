...
//	}
	...
	public Chefe(String _nome, String _identidade, Data _dataDeNascimento, String _dataDeAdmissao, double _salario,
			String _departamento) throws Exception {
		super(_nome, _identidade, _dataDeNascimento, _dataDeAdmissao, _salario);
		this.setDepartamento(_departamento);
	}
	
	public Chefe(String _nome, String _identidade, String _dataDeNascimento, Data _dataDeAdmissao, double _salario,
			String _departamento) throws Exception {
		super(_nome, _identidade, _dataDeNascimento, _dataDeAdmissao, _salario);
		this.setDepartamento(_departamento);
	}
	
	public Chefe(String _nome, String _identidade, Data _dataDeNascimento, Data _dataDeAdmissao, double _salario,
			String _departamento) throws Exception {
		super(_nome, _identidade, _dataDeNascimento, _dataDeAdmissao, _salario);
		this.setDepartamento(_departamento);
	}
	...
	public double valorMaximoEmprestimo() {
		return (2*super.valorMaximoEmprestimo());
	}
