...
public class LivroDeBiblioteca extends Livro implements ItemDeBiblioteca {
	...
	public LivroDeBiblioteca() {
		this("","",0,0,StatusEmprestimo.ACERVO, "","");
	}
	
	public LivroDeBiblioteca(String _titulo, String _autor, int _numeroPaginas, int _anoEdicao, StatusEmprestimo statusEmprestimo, String localizacao, String descricao) {
	...
	public boolean isEmprestado(){
		if(this.statusEmprestimo == StatusEmprestimo.EMPRESTADO) return true;
		else return false;
	}
	...
	public String localiza() {
		if(this.statusEmprestimo == StatusEmprestimo.EMPRESTADO) return "Emprestado";
		return this.localizacao;
	}
